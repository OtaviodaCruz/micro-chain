...
def createPodObj(podType, podName, dictParamsPod=managerConfig.pod_default_attrs, nodeName=None, commdPod = managerConfig.command_default, argsPod = managerConfig.arg_default):    
    try:
        ...
        container = client.V1Container(
            ...
            command=["/bin/bash","-c"], 
            args=["python3.6 Prometheus/listen_expose.py & " + commdPod[podType] + managerConfig.set_args(podType, podName, argsPod[podType])],  
            #env=[]
        )
