...
pod_default_attrs = {
    ...
    "container_image": "otaviocruz/ndn_microservice-content_store:test_timeout1",
    "template_labels": {"app": "microservice-content-store"},
    "limits":{"cpu": "1000m", "memory": "100M"} # 500m -> 0.5 (50%) of 1 core CPU. 300M -> 300 megabytes
    },
    "nr": {
    "container_name": "microservice-name-router",
    "container_image": "otaviocruz/ndn_microservice-name_router:test_timeout1",
